...
public class Publish {
    ...
    public Publish(int publishId, String username, String publishTitle,
            String publishComment, String publishImg, String publishAddress,
            String publishType, String publishDianzan, String publishDashang,
            Date publishDate) {
    ...
    this.publishDianzan = publishDianzan;
    this.publishDashang = publishDashang;
